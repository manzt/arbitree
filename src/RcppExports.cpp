...
RcppExport SEXP _arbitree_jaccard_coeff(SEXP R_idxSEXP, SEXP R_weightSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _arbitree_pnorm_over_mat(SEXP R_num_links_ijSEXP, SEXP R_var_null_num_linksSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_arbitree_jaccard_coeff", (DL_FUNC) &_arbitree_jaccard_coeff, 2},
    {"_arbitree_pnorm_over_mat", (DL_FUNC) &_arbitree_pnorm_over_mat, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_arbitree(DllInfo *dll) {
