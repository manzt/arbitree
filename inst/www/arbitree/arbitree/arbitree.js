...
/******/ 	return __webpack_require__(__webpack_require__.s = "./srcjs/arbitree.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
(function (global, factory) {
  ( false ? undefined : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory(__webpack_require__(/*! react */ "react")) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! react */ "react")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
  ...
  var tableau20 = ["#4c78a8", "#9ecae9", "#f58518", "#ffbf79", "#54a24b", "#88d27a", "#b79a20", "#f2cf5b", "#439894", "#83bcb6", "#e45756", "#ff9d98", "#79706e", "#bab0ac", "#d67195", "#fcbfd2", "#b279a2", "#d6a5c9", "#9e765f", "#d8b5a5"];

  function Doodleplot(_ref) {
    var _ref$data = _ref.data,
      ...
      left: 25
        ...
        strokeStyle = _ref$strokeStyle === void 0 ? "#000000" : _ref$strokeStyle,
        _ref$onDrawingFinish = _ref.onDrawingFinish,
        onDrawingFinish = _ref$onDrawingFinish === void 0 ? null : _ref$onDrawingFinish;
    ...
    var _useState3 = React.useState([]),
        ...
        strokes = _useState4[0],
        setStrokes = _useState4[1];

    var _useState5 = React.useState([]),
        _useState6 = _slicedToArray(_useState5, 2),
        currStroke = _useState6[0],
        setCurrStroke = _useState6[1];

    var canvasRef = React.useRef(null);
    var xScale = linear$1().range([margin.left, width - margin.right]).domain(extent(data, function (d) {
      return d.x;
    })).nice();
    ...
    function handleMouseUp() {
      setMouseDown(false);
      setStrokes([].concat(_toConsumableArray(strokes), [currStroke]));
    }
    ...
    function handleMouseMove(e) {
      if (mouseDown) {
        ...
        setCurrStroke([].concat(_toConsumableArray(currStroke), [[x, y]]));
        render();
      }
    }

    function handleClick() {
      onDrawingFinish(strokes.flat().map(function (_ref2) {
    ...
    function render() {
      ...
      var curve = curveBasis(ctx);
      ctx.lineJoin = "round";
      ctx.lineCap = "round";

      for (var _i = 0, _arr = [].concat(_toConsumableArray(strokes), [currStroke]); _i < _arr.length; _i++) {
        var stroke = _arr[_i];
        ctx.beginPath();
        curve.lineStart();
        ...
        try {
          for (var _iterator2 = stroke[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var point = _step2.value;
            curve.point.apply(curve, _toConsumableArray(point));
          }
        } catch (err) {
        ...
        if (stroke.length === 1) curve.point.apply(curve, _toConsumableArray(stroke[0]));
        curve.lineEnd();
    ...
    return React__default.createElement("div", {
    ...
    }), yScale.ticks().map(function (d, i) {
      return React__default.createElement("g", {
        transform: "translate(0,".concat(yScale(d), ")"),
        key: i
      }, React__default.createElement("line", {
        x2: -6,
        style: {
      ...
      transform: "translate(0,".concat(yScale.range()[0], ")"),
      style: {
        textAnchor: "middle",
        fontSize: 10
      }
    ...
    }), xScale.ticks().map(function (d, i) {
      return React__default.createElement("g", {
        transform: "translate(".concat(xScale(d), ",0)"),
        key: i
      }, React__default.createElement("line", {
        y2: 6,
        style: {
...
var ScatterInput = function ScatterInput(_ref) {
  ...
  return React.createElement(arbitree_react_component__WEBPACK_IMPORTED_MODULE_1___default.a, {
    data: JSON.parse(value),
    onDrawingFinish: handleOnDrawingFinish
  });
};

Object(reactR__WEBPACK_IMPORTED_MODULE_0__["reactShinyInput"])('.arbitree', 'arbitree.arbitree', ScatterInput);
...
/******/ });
//# sourceMappingURL=arbitree.js.map